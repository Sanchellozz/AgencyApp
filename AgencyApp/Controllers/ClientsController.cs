...
namespace AgencyApp.Controllers
{
    ...
    public class ClientsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("LicenseId,Passport,Id,FirstName,LastName,UserID")] Client client)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("LicenseId,Passport,Id,FirstName,LastName,UserID")] Client client)
        {
            if (id != client.Id)
            {
                return NotFound();
